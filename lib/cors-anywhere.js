...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    if (corsAnywhere.originBlacklist.indexOf(origin) >= 0) {
      ...
      console.warn('The origin "' + origin + '" was blacklisted by the operator of this proxy.');
      return;
    }
    ...
    if (corsAnywhere.originWhitelist.length && corsAnywhere.originWhitelist.indexOf(origin) === -1) {
      ...
      console.warn('The origin "' + origin + '" was not whitelisted by the operator of this proxy.');
      return;
    }
    ...
    if (rateLimitMessage) {
      ...
      console.warn('The origin "' + origin + '" has sent too many requests.\n' + rateLimitMessage);
      return;
    }
